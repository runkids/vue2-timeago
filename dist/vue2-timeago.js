...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default={short:{now:"すこし前",sec:" 秒",min:" 分",hour:" 時間",day:" 日"},long:{now:"すこし前",sec:" 秒前",min:" 分前",hour:" 時間前",day:" 日前"}};
},{}],"t7nU":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("./zh_TW"),r=_(e),u=require("./zh_CN"),t=_(u),d=require("./en"),l=_(d),a=require("./jp"),f=_(a);function _(e){return e&&e.__esModule?e:{default:e}}exports.default={zh_TW:r.default,zh_CN:t.default,en:l.default,jp:f.default};
},{"./zh_TW":"+8og","./zh_CN":"er76","./en":"4XV2","./jp":"hCoc"}],"xyyx":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("babel-runtime/helpers/classCallCheck"),t=n(e),r=require("babel-runtime/helpers/createClass"),a=n(r),i=require("./helper"),o=require("./lang/index"),u=n(o);function n(e){return e&&e.__esModule?e:{default:e}}var l=function(){function e(r,a,i){(0,t.default)(this,e),this.dateTime=r,this.locale=a||"en",this.type=i||"short"}return(0,a.default)(e,[{key:"setLocale",value:function(e){this.locale=e}},{key:"getTimeAgo",value:function(){var e=u.default[this.locale][this.type],t=e.now,r=e.min,a=e.hour,o=e.day,n=(0,i.toTimestamp)(this.dateTime),l=(0,i.getNow)(),s=((0,i.getToday)(),(0,i.getFirstDate)(),(l-n)/1e3);return{timeago:s<=0||Math.floor(s/60)<=0?t:s<3600?""+Math.round(s/60)+r:s>=3600&&Math.round(s/3600)<24?""+Math.round(s/3600)+a:s/86400<=31?""+Math.round(s/86400)+o:(0,i.getNowString)(n),nowString:(0,i.getNowMoreString)(n)}}}]),e}();exports.default=l;
